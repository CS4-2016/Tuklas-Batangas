    ...
    <div id="content">                        
            <div class="tuklasbatangas-main-content tuklasbatangas-space <?php if(!empty($_SESSION['username'])){ echo "tuklasbatangas-admin";} ?>">
                ...
                <div class="container">
                    <div class="row">
                    <center>
                        <button id="edit" class="btn btn-raised btn-primary tuklas-gridview" onclick="edit()">Edit 1</button>
         ...
         <form action="edit-pages.php" method="post">
                           ...
                           <input type="hidden" name="content" id="summernote-content">
                            <input type="hidden" name="page" id="summernote-content" value="message-from-the-governor">
