                    ...
                    <?php for($x=0; $x<count($search); $x++){ ?>
                        <div class="row" style="margin-bottom: 50px;">
                            <div class="col-md-3 col-md-offset-1">
                                <a href="view-poi.php?poi=<?php echo $search[$x]['id']?>">
                                    <?php 
                                        $gallery = $search[$x]['gallery'];
                                        $imgs = explode(',', $gallery); 
                                    ?>
                                    <img class="img-responsive" src="gallery/<?php echo $search[$x]['username']; ?>/<?php echo $imgs[0]; ?>" alt="Sorry! Image not available at this time" 
       onError="this.onerror=null;this.src='img/img-not-found.jpg';">
                                </a>
                            </div>
                            <div class="col-md-7">
                                <div class="tuklas-head"><a href="view-poi.php?poi=<?php echo $search[$x]['id']?>"><?php echo $search[$x]['establishment'] ?></a></div><br>
