                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>
                                If you would like to know how to get to this location, please follow these instructons:
                                <br><br>1. Enter a starting point location, or choose to use your current location by clicking on 
                                <br>the <strong>USE MY LOCATION</strong> button then allowing access to know your location.
                                <br><br>2. Click on the <strong>GET DIRECTIONS</strong> button. This will give you a list of directions, and the corresponding map.
                                <br><br>3. If you want to input a different location, click on the <strong>RESET</strong> button.
                            </p>
                        </div>
            ...
            <div class="container">
                <div class="row">
                       <div class="tuklas-header2">
                            ...
                            <br><br><br><br>
                            Establishment Location and Directions <i class="fa fa-question-circle fa-document-info" aria-hidden="true" type="button" data-toggle="modal" data-target="#establishment-modal"></i>     
                        </div><br>
